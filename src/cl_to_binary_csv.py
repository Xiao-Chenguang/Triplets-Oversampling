...
def process_ionosphere():
    ...
    df_ionosphere.to_csv(root + "ionosphere.csv", index=False, header=False)
...
def process_abalone():
    ...
    df_abalone = df_abalone[
        (df_abalone["Class_number_of_rings"] == b"9")
    ...
    df_abalone.to_csv(root + "abalone.csv", index=False, header=False)
...
def process_staimage():
    ...
    df_staimage.to_csv(root + "satimage.csv", index=False, header=False)
...
def process_haberman():
    ...
    df_haberman.to_csv(root + "haberman.csv", index=False, header=False)
...
def process_aloi():
    ...
    df_pulsar.to_csv(root + "aloi.csv", index=False, header=False)
